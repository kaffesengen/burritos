const vehiclePresets = {
    ...
    gokart: { power: 22.5, mass: 180, drivetrain: 'RWD', grip: 5.04, turn: 0.55, roll: 0.02, w: 14, l: 24, ev: false, type: 'gokart', fuelCap: 10, audio: 'gokart' },
            ...
            if (raceState > 0) { 
                ...
                if (preset.ev) {
                    ...
                    if ((mThrottle > 0 || isRev) && p.gear > 0 && p.shiftTimer <= 0) {
                        let torqueVal = 0;
                        if (preset.ev) {
                            torqueVal = aPower * 3.5 * Math.max(0.4, 1.0 - (p.rpm / 12000));
                        } else if (isGokart) {
                            let tqMul = 0;
