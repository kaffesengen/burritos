const vehiclePresets = {
    ai_standard: { power: 350, mass: 1400, drivetrain: 'AWD', grip: 2.10, turn: 4.8, roll: 0.04, w: 20, l: 45, ev: false, type: 'r34', fuelCap: 100, audio: 'turbo' },
    jaguar: { power: 400, mass: 2200, drivetrain: 'AWD', grip: 1.85, turn: 4.0, roll: 0.05, w: 24, l: 52, ev: true, type: 'jaguar', fuelCap: 100, audio: 'ev' },
    gokart: { power: 45, mass: 120, drivetrain: 'RWD', grip: 6.00, turn: 7.5, roll: 0.02, w: 16, l: 26, ev: false, type: 'gokart', fuelCap: 10, audio: 'gokart' },
    mx5: { power: 184, mass: 1050, drivetrain: 'RWD', grip: 1.60, turn: 4.5, roll: 0.04, w: 20, l: 42, ev: false, type: 'mx5', fuelCap: 50, audio: 'i4' },
    r34: { power: 330, mass: 1560, drivetrain: 'AWD', grip: 1.85, turn: 3.8, roll: 0.04, w: 22, l: 48, ev: false, type: 'r34', fuelCap: 70, audio: 'turbo' },
    s15: { power: 420, mass: 1240, drivetrain: 'RWD', grip: 1.70, turn: 5.5, roll: 0.04, w: 21, l: 45, ev: false, type: 's15', fuelCap: 65, audio: 'turbo' },
    f1: { power: 1050, mass: 798, drivetrain: 'RWD', grip: 3.60, turn: 6.0, roll: 0.09, w: 26, l: 64, ev: false, type: 'f1', fuelCap: 110, audio: 'v10' },
    gt3rs: { power: 525, mass: 1450, drivetrain: 'RWD', grip: 2.20, turn: 5.0, roll: 0.03, w: 20, l: 46, ev: false, type: 'r34', fuelCap: 64, audio: 'v6' },
    f40: { power: 478, mass: 1369, drivetrain: 'RWD', grip: 1.70, turn: 4.8, roll: 0.04, w: 20, l: 44, ev: false, type: 'r34', fuelCap: 120, audio: 'v8' },
    mclarenf1: { power: 627, mass: 1138, drivetrain: 'RWD', grip: 1.80, turn: 5.2, roll: 0.03, w: 19, l: 43, ev: false, type: 'r34', fuelCap: 90, audio: 'v10' },
    mazda787b: { power: 700, mass: 830, drivetrain: 'RWD', grip: 2.80, turn: 5.8, roll: 0.02, w: 20, l: 47, ev: false, type: 'r34', fuelCap: 100, audio: 'rotary' },
    m3e30: { power: 238, mass: 1200, drivetrain: 'RWD', grip: 1.65, turn: 4.6, roll: 0.04, w: 18, l: 43, ev: false, type: 'r34', fuelCap: 62, audio: 'i4' },
    elise: { power: 118, mass: 725, drivetrain: 'RWD', grip: 1.90, turn: 5.5, roll: 0.03, w: 17, l: 37, ev: false, type: 'mx5', fuelCap: 40, audio: 'i4' },
    gt40: { power: 485, mass: 1210, drivetrain: 'RWD', grip: 1.60, turn: 4.2, roll: 0.04, w: 19, l: 41, ev: false, type: 'r34', fuelCap: 140, audio: 'v8' },
    c8z06: { power: 670, mass: 1560, drivetrain: 'RWD', grip: 2.10, turn: 4.8, roll: 0.03, w: 21, l: 46, ev: false, type: 'r34', fuelCap: 70, audio: 'v8' },
    quattro: { power: 500, mass: 1090, drivetrain: 'AWD', grip: 2.00, turn: 5.3, roll: 0.03, w: 19, l: 42, ev: false, type: 'r34', fuelCap: 90, audio: 'turbo' },
    r32: { power: 280, mass: 1430, drivetrain: 'AWD', grip: 1.80, turn: 4.4, roll: 0.04, w: 19, l: 45, ev: false, type: 'r34', fuelCap: 72, audio: 'turbo' },
    alfa33: { power: 230, mass: 700, drivetrain: 'RWD', grip: 1.60, turn: 5.0, roll: 0.03, w: 17, l: 40, ev: false, type: 'r34', fuelCap: 50, audio: 'v8' },
    amggt: { power: 730, mass: 1615, drivetrain: 'RWD', grip: 2.20, turn: 4.7, roll: 0.03, w: 21, l: 46, ev: false, type: 'r34', fuelCap: 75, audio: 'v8' },
    nsxr: { power: 290, mass: 1230, drivetrain: 'RWD', grip: 1.80, turn: 5.1, roll: 0.03, w: 19, l: 44, ev: false, type: 'r34', fuelCap: 70, audio: 'v6' },
    type49: { power: 400, mass: 500, drivetrain: 'RWD', grip: 1.50, turn: 5.6, roll: 0.02, w: 18, l: 40, ev: false, type: 'f1', fuelCap: 60, audio: 'v8' },
    jesko: { power: 1600, mass: 1420, drivetrain: 'RWD', grip: 2.50, turn: 4.5, roll: 0.03, w: 21, l: 46, ev: false, type: 'r34', fuelCap: 72, audio: 'v8' },
    delta: { power: 210, mass: 1300, drivetrain: 'AWD', grip: 1.80, turn: 4.9, roll: 0.04, w: 18, l: 40, ev: false, type: 'r34', fuelCap: 57, audio: 'turbo' },
    valkyrie: { power: 1160, mass: 1030, drivetrain: 'RWD', grip: 3.20, turn: 5.8, roll: 0.02, w: 21, l: 45, ev: false, type: 'r34', fuelCap: 65, audio: 'v10' },
    yaris: { power: 261, mass: 1280, drivetrain: 'AWD', grip: 1.90, turn: 5.0, roll: 0.04, w: 18, l: 40, ev: false, type: 'r34', fuelCap: 50, audio: 'turbo' },
    porsche917: { power: 630, mass: 800, drivetrain: 'RWD', grip: 2.00, turn: 4.8, roll: 0.02, w: 20, l: 41, ev: false, type: 'r34', fuelCap: 120, audio: 'v10' },
    caterham: { power: 310, mass: 545, drivetrain: 'RWD', grip: 2.10, turn: 6.0, roll: 0.03, w: 16, l: 32, ev: false, type: 'f1', fuelCap: 36, audio: 'i4' }
};
...
function update() {
    ...
    if (isHost) {
        ...
        for (let pid of pkeys) {
            ...
            let maxEngineRpm = isGokart ? 13000 : 7500;
            let shiftUpRpm = isGokart ? 12200 : 7200;
            let shiftDownRpm = isGokart ? 8500 : 3500;
            let shiftDelay = isGokart ? 0.05 : 0.15;
            let aeroDrag = isGokart ? 0.50 : 0.45;
            let currentFinalDrive = isGokart ? 7.2 : finalDrive;
            ...
            if (raceState > 0) { 
                ...
                if (preset.ev) {
                    ...
                    if (ins.shiftUp && p.gear < 5 && p.shiftTimer <= 0) { p.gear++; p.shiftTimer = shiftDelay; p.manualGear = true; }
                    ...
                    let targetRpm = 1000 + wheelSpeedRpm * gearRatios[p.gear] * currentFinalDrive;
                    if (p.speedKmh < 10 && mThrottle > 0) { targetRpm += Math.abs(mThrottle) * (maxEngineRpm * 0.6) * (1 - p.speedKmh/10); }
                    
                    if (!p.manualGear) {
                        if (targetRpm > shiftUpRpm && p.gear < 5 && p.shiftTimer <= 0) { p.gear++; p.shiftTimer = shiftDelay; } 
                        else if (targetRpm < shiftDownRpm && p.gear > 1 && p.speedKmh > 10 && p.shiftTimer <= 0) { p.gear--; p.shiftTimer = shiftDelay; }
                    }

                    if (p.shiftTimer > 0) {
                        p.rpm += mThrottle * 8000 * dt; 
                        targetRpm = p.rpm; 
                    }

                    p.rpm += (targetRpm - p.rpm) * (isGokart ? 15 : 10) * dt;
                    if (p.rpm > maxEngineRpm) p.rpm = maxEngineRpm;

                    if ((mThrottle > 0 || isRev) && p.gear > 0 && p.shiftTimer <= 0) {
                        let torqueVal = 0;
                        if (isGokart) {
                            if (p.rpm < 4000) torqueVal = 0.15;
                            else if (p.rpm < 7000) torqueVal = 0.15 + ((p.rpm - 4000) / 3000) * 0.15;
                            else if (p.rpm < 11500) torqueVal = 0.30 + Math.pow((p.rpm - 7000) / 4500, 3.0) * 2.5;
                            else if (p.rpm < 13000) torqueVal = 2.8 - ((p.rpm - 11500) / 1500) * 2.0;
                            else torqueVal = 0.1;
                            torqueVal *= aPower;
                        } else {
                            torqueVal = aPower * 2.0 * Math.max(0.1, 1.0 - Math.pow((p.rpm - 5500)/4500, 2)); 
                        }
                        
                        dForce = (torqueVal * gearRatios[p.gear] * currentFinalDrive / wheelRadius) * mThrottle;
