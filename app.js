const vehiclePresets = {
    ...
    gokart: { power: 30, mass: 120, drivetrain: 'RWD', grip: 3.50, turn: 6.8, roll: 0.02, w: 16, l: 26, ev: false, type: 'gokart', fuelCap: 10, audio: 'gokart' },
...
function update() {
    ...
    if (isHost) {
        ...
        for (let pid of pkeys) {
            ...
            let shiftUpRpm = isGokart ? 11800 : 7200;
            let shiftDownRpm = isGokart ? 7000 : 3500;
            let shiftDelay = isGokart ? 0.05 : 0.15;
            let aeroDrag = isGokart ? 0.85 : 0.45;
                ...
                if (preset.ev) {
                    ...
                    if ((mThrottle > 0 || isRev) && p.gear > 0 && p.shiftTimer <= 0) {
                        ...
                        if (isGokart) {
                            ...
                            else if (p.rpm < 11500) torqueVal = 0.30 + Math.pow((p.rpm - 7000) / 4500, 2.5) * 1.8;
                            else if (p.rpm < 13000) torqueVal = 2.1 - ((p.rpm - 11500) / 1500) * 1.5;
                            else torqueVal = 0.1;
                            torqueVal *= aPower;
                        } else {
                        ...
                        dForce = (torqueVal * gearRatios[p.gear] * finalDrive / wheelRadius) * mThrottle;
