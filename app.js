const vehiclePresets = {
    ...
    gokart: { power: 26.5, mass: 180, drivetrain: 'RWD', grip: 5.04, turn: 0.55, roll: 0.02, w: 14, l: 24, ev: false, type: 'gokart', fuelCap: 10, audio: 'gokart', maxRPM: 14000, gears: [0, 2.50, 1.80, 1.45, 1.20, 1.02, 0.88], finalDrive: 4.8 },
...
function update() {
    ...
    if (isHost) {
        ...
        for (let pid of pkeys) {
            ...
            let aeroDrag = isGokart ? 0.95 : 0.45; 
            ...
            // Gass- og bremsepedal er nå helt separert basert på inputs (W = Gass, S = Brems)
            ...
            if (raceState > 0) { 
                ...
                if (preset.ev) {
                    ...
                    if (!p.manualGear && p.gear === 0) p.gear = 1;
            ...
            // Bremseeffekt uavhengig av retning (bremser farten ned)
